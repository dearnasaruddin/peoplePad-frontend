    ...
    return (
        <div className={`bg-blue-500/80 text-white flex items-center ${isHomeRoute ? 'justify-between p-2 lg:p-4' : 'py-2 lg:py-4 pl-2 lg:pl-4 pr-6 lg:pr-10'}`}>
            ...
            {isHomeRoute ?
                <>
                    {/* User */}
                    <div className="size-8 lg:size-10 flex justify-center items-center border border-blue-300 rounded-full cursor-pointer tooltip tooltip-bottom capitalize select-none" data-tip='profile'>
